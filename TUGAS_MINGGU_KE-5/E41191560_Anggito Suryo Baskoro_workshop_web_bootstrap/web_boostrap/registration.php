  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Page Heading -->
        <div class="d-sw-flex align-items-center justify-content-between mb-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-group">
                                <select name="agama" id="agama" class="form-control form-control-user" required>
                            ...
                            <div class="form-group">
                                <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control form-control-user" placeholder="Alamat Lengkap Anda" required></textarea>
                            </div>
