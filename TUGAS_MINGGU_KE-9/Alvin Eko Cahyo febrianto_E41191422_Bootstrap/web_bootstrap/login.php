              ...
              <div class="col-lg-6">
                ...
                <form class="user" method="post" action="login_process.php">
                  <div class="form-group">
                    <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Addres..." name="email" required>
                  </div>
                  <div class="form-group">
