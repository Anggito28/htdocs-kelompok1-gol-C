...
--
-- Database: `db_ecommerce_tanaman_hias`
--
...
ALTER TABLE `tb_produk`
  ...
  ADD KEY `kategori-barang` (`kd_kategori`);
...
--
ALTER TABLE `tb_akun`
  MODIFY `kd_akun` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_pembeli`
  MODIFY `kd_pembeli` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `wilayah_kabupaten`
  ADD CONSTRAINT `kab-prov` FOREIGN KEY (`provinsi_id`) REFERENCES `wilayah_provinsi` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
