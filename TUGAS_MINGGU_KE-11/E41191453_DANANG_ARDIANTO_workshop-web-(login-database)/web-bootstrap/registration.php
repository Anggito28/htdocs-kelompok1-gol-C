                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="">
                                        ...
                                        <select name="agama" id="agama" class="form-control form-group">
                                        ...
                                        <div class="form-group">
                                            <textarea name="biografi" class="form-control" id="biografi" rows="3" cols="40"></textarea>
                                        </div>

                                        <button type="submit" class="btn btn-success form-group" name="submit">Tambah</button>
